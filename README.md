...
Welcome to my GitHub portfolio. I'm a master's student in Systems, Control & Robotics at KTH (Sweden), with a BSc in Electrical Engineering. My work blends electrical engineering, signal processing, system modelling and more. 

- MSc in Systems, Control & Robotics @ KTH
- Interests: AI, NLP, Deep Learning, Control Systems
- Currently working on: Terminology-Inspired Automatic Term Extraction in Gaming Patch Notes + Domain Generalizability
...
- Full materials can be shared upon request under special circumstances (e.g. for academic or recruitment purposes), contact me to be added to that repository. 
...
- Climbing coach, instructor and writer
